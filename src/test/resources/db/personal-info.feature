...
Feature: Storing Personal Information in Duobank Mortgage Application
  ...
  Scenario: Storing Borrower and Co-Borrower Personal Information
    ...
    When I enter the borrower's information:
      | First Name | Middle Name | Last Name | Suffix | Email | Date of Birth | SSN | Marital Status | Cell | Home | Realtor info |
      | John       | M            | Doe       | Mr     | john.doe@email.com | 01/01/1980 | 123-45-6789 | Single | 1234567890 | 9876543210 | John Doe |
