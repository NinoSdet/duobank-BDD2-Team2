Feature: Employment-Income feature
  ...
  Background: Common steps for all scenarios in Employment and Income page
...
@Anar
  Scenario: User is able to see the STATE dropdown list with all US states
...
@Anar
  ...
  Scenario Outline: User  is able to enter dollar amount in each field of Additional Gross Monthly Income section
    ...
    When the user enters additional income1 as "<income1>" additional income2 as "<income2>" and additional income3 as "<income3>"
